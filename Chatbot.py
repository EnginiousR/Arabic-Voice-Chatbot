...
class VoiceChatbot:
    ...
    def think(self, text):
        response = self.cohere.chat(model="command-r7b-arabic-02-2025",message=text,temperature=0.7,max_tokens=200, preamble="جاوب بلهجة سعودية فقط، جاوب بشكل مختصر، اسمك هو المساعد الذكي وقد صممتك ربى المالكي")
